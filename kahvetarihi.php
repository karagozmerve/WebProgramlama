...
?>
	...
	<b style="visibility: hidden;">boşluk</b><br />
<div class="container">
	<h1 style="color: #622728;">Kahvenin Tarihi</h1>
	<h4><i>Güne iyi başlamak, ayılmak, belki de biraz keyif almak için alırız fincanı elimize… Şimdi birer kahve eşliğinde kahvenin o sıcacık yolculuğunu ve yaşamımızdaki yerini okuyalım...</i></h4>
	<hr />
	<br />
	<br />
	<table>
	<tr>
	<td><img src="kaldi.jpg" /></td>	
	<td><img src="KALDİEF.png" width="500" height="350"/></td>
	</tr>
	<tr>
	...
	<tr>
	<td><img src="KAHVEARAPYARIMADASI.png" width="500" height="300"/></td>
	<td><img src="kahve-arapyarimadasinda-KahveKafe-640x320.jpg" width="500" height="250" /></td>
	</tr>
	<tr>
	<td style="visibility: hidden;">boşluk</td>	
	<td style="visibility: hidden;">boşluk</td>
	...
	<tr>
	<td ><img src="kahve-avrupada-kahvenin-tarihi-KahveKafe-640x320.jpg" width="470" height="280"/></td>	
	<td ><img src="KAHVEAVRUPAYAGELİR.png" width="500" height="400"/></td>
	</tr>
	<tr>
	<td style="visibility: hidden;">boşluk</td>	
	<td style="visibility: hidden;">boşluk</td>
	...
	<tr>
	<td><img src="kisspng-post-it-note-paper-clip-color-sticky-notes-5a7234cbe08155.8585805615174340599196.png" /></td>	
	<td><img src="kuru-kahve.jpg" /></td>
	</tr>
	</table>
</div>	
	<br />
